...
import openpyxl
# load the data
data = pd.read_excel('https://raw.githubusercontent.com/sid-almeida/fernando_elemar_dados/main/fernanddo.csv?token=GHSAT0AAAAAACEWO6QOFKVV4PHQSQ5ZEWQQZFVTKIA', encoding='cp1258', index_col=0)
